...
function renderViagemCard($date, $origem, $destino, $lugares, $localidade, $preco, $id) {
  ...
  <div class="col-md-4 mb-4">
    ...
    <div class="card-body py-4 px-3">
      ...
      <a class="link-900 text-decoration-none stretched-link" href="#!" class="fs-0 fw-medium" onclick="editarViagem('. $id .', \''. $origem .'\', \''. $destino .'\', \''. $date .'\', '. $lugares .', '. $preco .')">editar Viagem</a>
      </div>
    </div>
